...
/**
 * Simulation strategy that simulates a charging session where start is rejected.
 * The session requests to start but gets immediately rejected.
 */
internal class StartRejectedSimulationStrategy(
    private val sessionFactory: ChargingSessionFactory,
    private val rejectionDelay: Int = 2
