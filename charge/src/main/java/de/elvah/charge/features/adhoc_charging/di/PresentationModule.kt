...
internal val adHocViewModelModule = module {
    ...
    viewModel<ChargingPointDetailViewModel> { (args: AdHocChargingScreens.ChargingPointDetailRoute) ->
        ChargingPointDetailViewModel(args, get(), get(), get(), get(), get(), get(), get())
    }
